...
namespace SPI
{
    /*
        ...
        for type check, declaration, name reuse, etc
    ...
    */
    ...
    class PASCAL
    {
        const string VER = "Part 13: semantic analysis";
        ...
        static int Main(string[] args)
        {
            ...
            Debug.trace = Debug.MODULE.SYMBOLTABLE;
            Debug.dump =  Debug.DUMP.PRINT_ALL;
