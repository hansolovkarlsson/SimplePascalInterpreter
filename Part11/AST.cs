...
namespace SPI
{
	...
	abstract class AST
	{
		...
		public AST()
		{
			...
			token = new Token(Token.TYPE.NONE, null);
		}
	...
	class NodeBlock : AST
	{
		public List<NodeVarDecl>	declarations; // using compound maybe?
		public NodeCompound			compound_statement;

		public NodeBlock(List<NodeVarDecl> declarations, NodeCompound compound_statement)
		{
