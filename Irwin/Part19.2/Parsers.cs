...
namespace SPI
{
    ...
    class Parser
    {
        ...
        {
            Debug.Trace(Debug.TRACE.PARSER, $"Eat({token_type.ToString()})");
        ...
        {
            Debug.Trace(Debug.TRACE.PARSER, $"Program()");
        ...
        {
            Debug.Trace(Debug.TRACE.PARSER, $"Block()");
        ...
        {
            Debug.Trace(Debug.TRACE.PARSER, $"Declarations()");
        ...
        {
            Debug.Trace(Debug.TRACE.PARSER, $"FormalParameters()");
        ...
        {
            Debug.Trace(Debug.TRACE.PARSER, $"FormalParameterList()");
        ...
        {
            Debug.Trace(Debug.TRACE.PARSER, $"VariableDeclaration()");
        ...
        {
            Debug.Trace(Debug.TRACE.PARSER, $"TypeSpec()");
            ...
            if(token.type == TokenType.INTEGER)
                ...
                Debug.Error($"Error: Parser.TypeSpec token.type unknown '{token.type.ToString()}");
        ...
        {
            Debug.Trace(Debug.TRACE.PARSER, $"CompoundStatement()");
        ...
        {
            Debug.Trace(Debug.TRACE.PARSER, $"StatementList()");
        ...
        {
            Debug.Trace(Debug.TRACE.PARSER, $"Statement()");
            ...
            else if (current_token.type == TokenType.WRITE || current_token.type == TokenType.WRITELN)
                node = WriteStatement();
        ...
        {
            Debug.Trace(Debug.TRACE.PARSER, "ProcCallStatement()");
        ...
        public NodeWriteStatement WriteStatement()
        {
            // write_statement : (WRITE | WRITELN) (LPAR (expr (COMMA expr)*)? RPAR)?
            NodeWriteStatement node = new NodeWriteStatement();

            // eat token, get actual parameters
            if(current_token!.type == TokenType.WRITE)
                Eat(TokenType.WRITE);
            else if(current_token.type == TokenType.WRITELN) {
            ...
            if(current_token.type == TokenType.LPAR) {
                ...
                while(current_token.type != TokenType.RPAR) {
                    // parse expression
        ...
        {
            Debug.Trace(Debug.TRACE.PARSER, "AssignmentStatement()");
        ...
        {
            Debug.Trace(Debug.TRACE.PARSER, "Variable()");
        ...
        {
            Debug.Trace(Debug.TRACE.PARSER, $"Empty()");
        ...
        public AST Expr()
        {
            Debug.Trace(Debug.TRACE.PARSER, $"Expr()");
        ...
        public AST Term()
        {
            Debug.Trace(Debug.TRACE.PARSER, $"Term()");
        ...
        public AST Factor()
        {
            Debug.Trace(Debug.TRACE.PARSER, $"Factor()");
            ...
            } else if (token.type == TokenType.STRING_CONST ) { // string 'xxx'
                Eat(TokenType.STRING_CONST);
                ret = new NodeStr(token);
        ...
        public NodeProgram Parse()
        {
            ...
            */
            ...
            Debug.Trace(Debug.TRACE.PARSER, $"Parse()");

            NodeProgram ret = Program();
            Debug.Trace(Debug.TRACE.PARSER, $"Program()=>{ret.token.Str()}");
            ...
            if((Debug.dump & Debug.DUMP.AST)>0)
